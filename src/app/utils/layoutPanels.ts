export type WorkspaceView = 'chat' | 'browser' | 'workflow' | 'skills' | 'capabilities' | 'editor' | 'settings' | 'usage';
...
export function resolveAdaptivePanelVisibility(args: AdaptivePanelVisibilityArgs): AdaptivePanelVisibility {
  ...
  return {
    ...
    showCapabilities: activeView === 'capabilities',
...
export function resolveSinglePageSyncState(args: {
  ...
  const currentViewState =
    ...
    args.singlePageView === 'capabilities' ||
...
export function resolveRailState(args: {
  ...
  if (args.singlePageMode) {
    return {
      ...
      capabilitiesActive: args.singlePageView === 'capabilities',
  ...
  return {
    chatActive: args.activeWorkspaceView === 'chat' || (args.activeWorkspaceView !== 'workflow' && args.activeWorkspaceView !== 'skills' && args.activeWorkspaceView !== 'capabilities' && !args.effectiveEditorOpen && !args.isSettingsOpen && !args.isUsageOpen && !args.isBrowserOpen),
    ...
    capabilitiesActive: args.activeWorkspaceView === 'capabilities',
